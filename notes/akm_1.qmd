...
### The AKM Econometric Model: Decomposing the Wage Equation
...
%%| fig-alt: "A diagram showing a main network where worker moves link Firms A, B, C, and D, and a separate, isolated network of Firms X and Y."
graph LR
