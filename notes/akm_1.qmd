...
More broadly, AKM marked a turning point in labor economics by treating worker and firm fixed effects not as nuisances but as core quantities of interest. This shift led to the widespread adoption of high-dimensional fixed effects regressions in matched employer-employee data. Rather than relying solely on firm observables like size or sector, economists began using large-scale administrative data to identify which firms systematically pay more or less, and then relate these patterns to observables in a second step.

Some of AKM’s early empirical findings were later shown to be influenced by approximation errors in solving the high-dimensional least squares problem, as highlighted in follow-up studies (Abowd, Creecy, and Kramarz 2002; Abowd, Lengermann, and McKinney 2003).
