...
%%| fig-alt: "A diagram showing two distinct networks of worker mobility. The top, isolated set shows movement between Firm X and Y. The bottom, main connected set, shows a chain of moves linking Firm A, B, C, and D."
graph TD
    ...
    %% Styling
    style A fill:#e3f2fd,stroke:#2980b9,stroke-width:2px
    style B fill:#e3f2fd,stroke:#2980b9,stroke-width:2px
    style C fill:#e3f2fd,stroke:#2980b9,stroke-width:2px
    style D fill:#e3f2fd,stroke:#2980b9,stroke-width:2px

    style X fill:#fde0dd,stroke:#c62828,stroke-width:2px
    style Y fill:#fde0dd,stroke:#c62828,stroke-width:2px
```
